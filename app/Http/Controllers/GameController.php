...
class GameController extends Controller
{
    ...
    public function __construct(private readonly HTMLBuilder $builder)
    {
    }
    ...
    public function index(Request $request): View|Factory|Redirector|string|RedirectResponse|Application
    {
        ...
        $gamesPaginated = ArrayPagination::paginate($games, $total, $page, $perPage);
    ...
    {
        /** @var string $data */
        $data = file_get_contents(env('STEAM_URL').$steamGameId);
